...
<div id="sf_admin_container">
  <h1><?php echo __('Editar Usuario "%%username%%"', array('%%username%%' => $sf_guard_user->getUsername()), 'messages') ?></h1>
  ...
  <div id="sf_admin_content">
    <?php include_partial('sfGuardUser/form', array('sf_guard_user' => $sf_guard_user, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper, 'carreras' => $carreras, 'codigos' => $codigos, 'solicitudes' => $solicitudes)) ?>
  </div>
