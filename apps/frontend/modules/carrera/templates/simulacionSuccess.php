        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td>
                        <input style="width: 40px;"id="ingreso-unidadI" onkeypress="return soloNumeros(event);" name="unidadI">
                    </td>
        ...
        <table>
            <tbody>
                <tr>
                    <th><label>Unidad:<b style="color: red;">*</b></label></th>
                    <td>
                        <input style="width: 40px;"id="codigo-unidadI" onkeypress="return soloNumeros(event);" name="unidadI">
                    </td>
                    <th><label>Conductor:</label></th>
