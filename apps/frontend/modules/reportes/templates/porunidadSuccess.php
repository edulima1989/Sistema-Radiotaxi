<h1>Consulta de carreras por unidad</h1>
        ...
        <tr>
            ...
            <td><select name="vehiculo">
                    ...
                    <?php foreach ($unidades as $unidad): ?>
                        <option value="<?php echo $unidad->getId() ?>"
                        <?php if ($sf_request->getParameter('vehiculo') == $unidad->getId()) echo 'selected="selected"' ?>
...
<div style="padding-left: 30px;"> <img style="padding-left: 45px;" src="../../../../images/pdf.jpg" border="0" width="40" height="47">
    <br />
    <a style="border-style: solid;" target="_blank" href="<?php echo url_for('reportes/reportePorUnidad') ?>" >Generar Reporte</a>
</div>