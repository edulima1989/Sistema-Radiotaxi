<h1>Consulta de carreras por código</h1>
<form  id="gestion" action="" method="post">
    ...
    <label>Seleccione el código para el que desea buscar las carreras realizadas.</label>   
    <table>
        <tr>
            <th>Código: </th>
            <td><div class=""><input name="codigo" value="<?php echo $sf_request->getParameter('codigo')?>" id="codigo"/></div></td>
        </tr>
    </table>
    <br />
...
<div style="padding-left: 30px;"> <img style="padding-left: 45px;" src="../../../../images/pdf.jpg" border="0" width="40" height="47">
    <br />
    <a style="border-style: solid;" target="_blank" href="<?php echo url_for('reportes/reportePorCodigo') ?>" >Generar Reporte</a>
</div>