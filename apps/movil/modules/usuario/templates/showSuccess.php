...
<a class="link_show" href="<?php echo url_for('usuario/edit?id='.$sf_guard_user->getId()) ?>">Editar Datos</a>
<a class="link_show" href="<?php echo url_for('usuario/contrasena?id='.$sf_guard_user->getId()) ?>">Cambiar Contraseña</a>
<hr />
