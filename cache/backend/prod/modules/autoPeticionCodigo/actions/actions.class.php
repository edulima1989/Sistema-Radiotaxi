...
require_once(dirname(__FILE__).'/../lib/BasePeticionCodigoGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BasePeticionCodigoGeneratorHelper.class.php');
 ...
 */
abstract class autoPeticionCodigoActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->peticion_codigo = $this->form->getObject();
  }
  ...
  {
    $this->peticion_codigo = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->peticion_codigo);
  }
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      $this->dispatcher->notify(new sfEvent($this, 'admin.save_object', array('object' => $peticion_codigo)));

      if ($request->hasParameter('_save_and_add'))
      {
        $this->getUser()->setFlash('notice', $notice.' You can add another one below.');

        $this->redirect('@peticion_codigo_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'peticion_codigo_edit', 'sf_subject' => $peticion_codigo));
      }
    }
    else
    {
