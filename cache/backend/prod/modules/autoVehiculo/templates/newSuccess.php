...
<div id="sf_admin_container">
  <h1><?php echo __('Crear Unidad', array(), 'messages') ?></h1>
  ...
  <div id="sf_admin_content">
    <?php include_partial('Vehiculo/form', array('vehiculo' => $vehiculo, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>
